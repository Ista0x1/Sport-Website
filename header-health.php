...
<head>
    ...
    <!-- Custom CSS file -->
    <link rel="stylesheet" href="./food/health-more.css">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav m-auto font-rubik">
                    ...
                    <li class="nav-item active">
                      <a class="nav-link" href="health.php">Health <i class="fas fa-chevron-down"></i></a><ul style="display:none;" class="color-second-bg">
