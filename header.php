...
<head>
    ...
    <link rel="stylesheet" href="workout/muscl.css">
...
?>
    <!-- start #header -->
        <header id="header">
          <script>
            let act =document.getElementById('nav-item');
            act.cssText ='color:red;';
          </script>
            <!-- Primary Navigation -->
            <nav class="navbar navbar-expand-lg navbar-dark color-second-bg">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav m-auto font-rubik">
                    <li class="nav-item  ">
                      <a class="nav-link" href="./index.php"><?php echo $ipaddress; ?></a>
                    </li>
                  ...
                  <form action="#" class="font-size-14 font-rale"><a href="register.php">
